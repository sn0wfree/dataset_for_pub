...
group factor PROJECT_STATE_CODE  BACKERS_COUNT COMMENTS_COUNT CREATOR_FRIENDS_FACEBOOK DURATION GINI_COEF GOAL_USD HAS_A_VIDEO_D  UPDATES_NUMBER BACKED100_N BACKED10_50 BACKED1_10 BACKED50_100 CREATED10_25 CREATED1_10 CREATED25_N 
'freeze({%i}factorstats) factor.stats


equation {%i}withall.binary(d=l) PROJECT_STATE_CODE c BACKERS_COUNT COMMENTS_COUNT CREATOR_FRIENDS_FACEBOOK DURATION GINI_COEF GOAL_USD HAS_A_VIDEO_D  UPDATES_NUMBER BACKED100_N BACKED10_50 BACKED1_10 BACKED50_100 CREATED10_25 CREATED1_10 CREATED25_N GINI_COEF
...
'equation {%i}wofv.binary(d=l) PROJECT_STATE_CODE c passsucceed_  BACKERS_COUNT COMMENTS_COUNT  DURATION GOAL_USD  UPDATES_NUMBER 
